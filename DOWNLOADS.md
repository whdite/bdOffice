...
```sh
minisign -Vm BigDogOffice-0.8.5-windows-x64.exe -P RWQzJu6+Jww+ZBxyLybA+HIpfIIp+DBGe0/dA29WMOaZW2F/w6UPTxYC
```
...
- 固定版本资源：`https://github.com/whdite/bdOffice/releases/download/v0.8.5/<资产文件名>`。
...
本入口用于安装器下载与服务器同步，不代表桌面应用已经启用静默自动升级。
